  ...
  />
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '22px' }}>
            <SocialBtn
              ...
              label="Google" onClick={() => { setOauthLoading('google'); 
               console.log("GOOGLE CLIENT ID:", process.env.REACT_APP_GOOGLE_CLIENT_ID);
console.log("URL:", getGoogleAuthUrl()); window.location.href = getGoogleAuthUrl(); }} loading={oauthLoading === 'google'} color="#4285F4"
            />
